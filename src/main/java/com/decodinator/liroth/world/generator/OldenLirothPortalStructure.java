...
public class OldenLirothPortalStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public OldenLirothPortalStructure(Codec<StructurePoolFeatureConfig> codec) {
        // Create the pieces layout of the structure and give it to the game
        super(codec, OldenLirothPortalStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!OldenLirothPortalStructure.isFeatureChunk(context)) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(
                ...
                () -> context.registryManager().get(Registry.STRUCTURE_POOL_KEY)
                        .get(new Identifier(Liroth.MOD_ID, "olden_liroth_portal/rarity_shid")),
