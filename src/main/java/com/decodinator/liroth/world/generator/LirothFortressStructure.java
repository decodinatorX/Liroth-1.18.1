...
public class LirothFortressStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public LirothFortressStructure(Codec<StructurePoolFeatureConfig> codec) {
        // Create the pieces layout of the structure and give it to the game
        super(codec, LirothFortressStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static final Pool<SpawnSettings.SpawnEntry> STRUCTURE_MONSTERS = Pool.of(
            new SpawnSettings.SpawnEntry(Liroth.FORSAKEN_CORPSE, 100, 4, 9),
            new SpawnSettings.SpawnEntry(Liroth.SKELETAL_FREAK, 100, 4, 9)
    );
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!LirothFortressStructure.isFeatureChunk(context)) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(
                ...
                () -> context.registryManager().get(Registry.STRUCTURE_POOL_KEY)
                        .get(new Identifier(Liroth.MOD_ID, "fortresses/liroth/start_pool")),
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Liroth.LOGGER.debug("sus" + blockpos, Level.DEBUG);
        }
