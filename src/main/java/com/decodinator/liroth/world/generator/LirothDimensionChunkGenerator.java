...
public class LirothDimensionChunkGenerator extends ChunkGenerator {
	// Just an example of adding a custom boolean
	protected final boolean customBool;

	public static final Codec<LirothDimensionChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
			instance.group(
			...
			.apply(instance, instance.stable(LirothDimensionChunkGenerator::new))
	);

	public LirothDimensionChunkGenerator(BiomeSource biomeSource, boolean customBool) {
