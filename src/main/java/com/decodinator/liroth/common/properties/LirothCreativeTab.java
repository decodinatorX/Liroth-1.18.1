...
public class LirothCreativeTab {
    ...
    public static final ItemGroup creativeEntitiesTab = FabricItemGroupBuilder.build(new Identifier(Liroth.MOD_ID, "liroth_entities"), () -> new ItemStack(Liroth.FORSAKEN_CORPSE_SPAWN_EGG));
