...
public class ProwlerModel<T extends ProwlerEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		partdefinition.addChild("body", ModelPartBuilder.create().uv(28, 14).cuboid(-4.0F, 4.0F, -2.0F, 8.0F, 8.0F, 4.0F)
		...
		head.addChild("cube_r1", ModelPartBuilder.create().uv(0, 0).cuboid(3.0F, -18.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(52, 28).cuboid(2.0F, -12.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(24, 34).cuboid(3.0F, -14.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(32, 8).cuboid(5.0F, -14.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(0, 22).cuboid(6.0F, -16.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		...
		partdefinition.addChild("hat", ModelPartBuilder.create().uv(0, 18).cuboid(-4.0F, -7.5F, -4.0F, 8.0F, 8.0F, 8.0F), ModelTransform.pivot(0.0F, -18.0F, 0.0F));

		partdefinition.addChild("rightArm", ModelPartBuilder.create().uv(20, 42).cuboid(0.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F)
		...
		partdefinition.addChild("leftArm", ModelPartBuilder.create().uv(20, 50).cuboid(-2.0F, 8.0F, 0.0F, 2.0F, 7.0F, 2.0F)
