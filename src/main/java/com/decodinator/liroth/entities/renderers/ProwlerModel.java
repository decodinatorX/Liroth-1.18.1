...
public class ProwlerModel<T extends ProwlerEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = partdefinition.addChild("body", ModelPartBuilder.create().uv(28, 14).cuboid(-4.0F, 4.0F, -2.0F, 8.0F, 8.0F, 4.0F)
		...
		ModelPartData head = partdefinition.addChild("head", ModelPartBuilder.create().uv(32, 12).mirrored().cuboid(-8.0F, -5.0F, 0.0F, 4.0F, 1.0F, 1.0F).mirrored(false)
		...
		.uv(40, 0).cuboid(4.0F, -6.0F, 0.0F, 5.0F, 1.0F, 1.0F)
		.uv(32, 12).cuboid(4.0F, -7.0F, 0.0F, 4.0F, 1.0F, 1.0F)
		.uv(32, 12).cuboid(4.0F, -5.0F, 0.0F, 4.0F, 1.0F, 1.0F)
		.uv(32, 12).mirrored().cuboid(-8.0F, -7.0F, 0.0F, 4.0F, 1.0F, 1.0F).mirrored(false)
		.uv(40, 0).mirrored().cuboid(-9.0F, -6.0F, 0.0F, 5.0F, 1.0F, 1.0F).mirrored(false)
		.uv(0, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F), ModelTransform.pivot(0.0F, -18.0F, 0.0F));

		ModelPartData cube_r1 = head.addChild("cube_r1", ModelPartBuilder.create().uv(0, 0).cuboid(3.0F, -18.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(52, 28).cuboid(2.0F, -12.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(24, 34).cuboid(3.0F, -14.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(32, 8).cuboid(5.0F, -14.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(0, 22).cuboid(6.0F, -16.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(0, 18).cuboid(5.0F, -12.0F, -1.0F, 2.0F, 2.0F, 2.0F)
		.uv(0, 4).cuboid(5.0F, -18.0F, -1.0F, 2.0F, 2.0F, 2.0F), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

		ModelPartData hat = partdefinition.addChild("hat", ModelPartBuilder.create().uv(0, 18).cuboid(-4.0F, -7.5F, -4.0F, 8.0F, 8.0F, 8.0F), ModelTransform.pivot(0.0F, -18.0F, 0.0F));

		ModelPartData rightArm = partdefinition.addChild("rightArm", ModelPartBuilder.create().uv(20, 42).cuboid(0.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F)
		.uv(20, 50).cuboid(0.0F, 8.0F, 0.0F, 2.0F, 7.0F, 2.0F)
		.uv(10, 43).cuboid(0.0F, 15.0F, -0.5F, 2.0F, 13.0F, 2.0F), ModelTransform.pivot(5.5F, -16.0F, 0.0F));

		ModelPartData leftArm = partdefinition.addChild("leftArm", ModelPartBuilder.create().uv(20, 50).cuboid(-2.0F, 8.0F, 0.0F, 2.0F, 7.0F, 2.0F)
		.uv(20, 42).cuboid(-2.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F)
