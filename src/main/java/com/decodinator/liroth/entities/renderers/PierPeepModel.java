...
public class PierPeepModel<T extends PierPeepEntity> extends EntityModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		.texOffs(0, 14).addBox(0.0F, -6.0F, 4.0F, 0.01F, 4.0F, 8.0F), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 14).addBox(-4.0F, -2.0F, 4.0F, 0.01F, 4.0F, 8.0F),
