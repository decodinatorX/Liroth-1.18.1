...
extends Entity {
    ...
    public PierBoatEntity(EntityType<? extends PierBoatEntity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    public PierBoatEntity(World world, double x, double y, double z) {
        this(LirothEntities.PIER_BOAT, world);
