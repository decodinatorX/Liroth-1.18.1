...
public class ChestJapzBoatEntity
extends JapzBoatEntity
...
VehicleInventory {
    ...
    public ChestJapzBoatEntity(EntityType<? extends JapzBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestJapzBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_JAPZ_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_JAPZ_BOAT;
    }
