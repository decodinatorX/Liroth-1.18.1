...
public class ChestLirothBoatEntityModel extends CompositeEntityModel<ChestLirothBoatEntity> {
    ...
    public ChestLirothBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestLirothBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestLirothBoatEntity entity, int sigma, ModelPart part, float angle) {
