...
public class ChestJapzBoatEntityModel extends CompositeEntityModel<ChestJapzBoatEntity> {
    ...
    public ChestJapzBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestJapzBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestJapzBoatEntity entity, int sigma, ModelPart part, float angle) {
