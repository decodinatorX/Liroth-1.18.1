...
public class PetrifiedBoatEntityRenderer extends EntityRenderer<PetrifiedBoatEntity> {

    private final PetrifiedBoatEntityModel model;
    private final Identifier texture;


    public PetrifiedBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new PetrifiedBoatEntityModel(ctx.getPart(LirothClient.MODEL_PETRIFIED_DAMNATION_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/petrified_damnation.png");
    }

    public void render(PetrifiedBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        PetrifiedBoatEntityModel model = this.model;
        Identifier identifier = texture;
        PetrifiedBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(PetrifiedBoatEntity entity) {
        return this.texture;
    }
