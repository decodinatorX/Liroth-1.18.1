...
public class ChestPierBoatEntityRenderer extends EntityRenderer<ChestPierBoatEntity> {

    private final ChestPierBoatEntityModel model;
    private final Identifier texture;


    public ChestPierBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new ChestPierBoatEntityModel(ctx.getPart(LirothClient.MODEL_CHEST_TALLPIER_BOAT_LAYER), true);
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/chest_boat/tallpier.png");
    }

    public void render(ChestPierBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        ChestPierBoatEntityModel model = this.model;
        Identifier identifier = texture;
        ChestPierBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(ChestPierBoatEntity entity) {
        return this.texture;
    }
