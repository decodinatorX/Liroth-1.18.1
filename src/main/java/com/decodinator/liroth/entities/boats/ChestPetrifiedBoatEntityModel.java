...
public class ChestPetrifiedBoatEntityModel extends CompositeEntityModel<ChestPetrifedBoatEntity> {
    ...
    public ChestPetrifiedBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestPetrifedBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestPetrifedBoatEntity entity, int sigma, ModelPart part, float angle) {
