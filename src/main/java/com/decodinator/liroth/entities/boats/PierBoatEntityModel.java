...
public class PierBoatEntityModel extends CompositeEntityModel<PierBoatEntity> {
    ...
    public PierBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(PierBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(PierBoatEntity entity, int sigma, ModelPart part, float angle) {
