...
public class ChestKoolawBoatEntity
extends KoolawBoatEntity
...
VehicleInventory {
    ...
    public ChestKoolawBoatEntity(EntityType<? extends KoolawBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestKoolawBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_KOOLAW_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_KOOLAW_BOAT;
    }
