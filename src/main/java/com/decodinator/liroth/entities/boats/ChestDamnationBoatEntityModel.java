...
public class ChestDamnationBoatEntityModel extends CompositeEntityModel<ChestDamnationBoatEntity> {
    ...
    public ChestDamnationBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestDamnationBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestDamnationBoatEntity entity, int sigma, ModelPart part, float angle) {
