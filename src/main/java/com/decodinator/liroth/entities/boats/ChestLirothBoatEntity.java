...
public class ChestLirothBoatEntity
extends LirothBoatEntity
...
VehicleInventory {
    ...
    public ChestLirothBoatEntity(EntityType<? extends LirothBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestLirothBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_LIROTH_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_LIROTH_BOAT;
    }
