...
public class ChestPierBoatEntityModel extends CompositeEntityModel<ChestPierBoatEntity> {
    ...
    public ChestPierBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestPierBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestPierBoatEntity entity, int sigma, ModelPart part, float angle) {
