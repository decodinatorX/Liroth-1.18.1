...
extends Entity {
    ...
    public LirothBoatEntity(EntityType<? extends LirothBoatEntity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    public LirothBoatEntity(World world, double x, double y, double z) {
