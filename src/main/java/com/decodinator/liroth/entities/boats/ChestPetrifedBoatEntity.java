...
public class ChestPetrifedBoatEntity
...
VehicleInventory {
    ...
    public ChestPetrifedBoatEntity(EntityType<? extends PetrifiedBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestPetrifedBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_PETRIFIED_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_PETRIFIED_BOAT;
    }
