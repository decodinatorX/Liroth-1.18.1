...
public class ChestDamnationBoatEntity
...
VehicleInventory {
    ...
    public ChestDamnationBoatEntity(EntityType<? extends DamnationBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestDamnationBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_DAMNATION_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_DAMNATION_BOAT;
    }
