...
public class ChestSpicedBoatEntity
extends SpicedBoatEntity
...
VehicleInventory {
    ...
    public ChestSpicedBoatEntity(EntityType<? extends SpicedBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestSpicedBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_SPICED_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_SPICED_BOAT;
    }
