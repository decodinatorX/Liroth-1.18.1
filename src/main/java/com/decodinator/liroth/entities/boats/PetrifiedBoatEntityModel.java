...
public class PetrifiedBoatEntityModel extends CompositeEntityModel<PetrifiedBoatEntity> {
    ...
    public PetrifiedBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(PetrifiedBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(PetrifiedBoatEntity entity, int sigma, ModelPart part, float angle) {
