...
public class PierBoatEntityRenderer extends EntityRenderer<PierBoatEntity> {

    private final PierBoatEntityModel model;
    private final Identifier texture;


    public PierBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new PierBoatEntityModel(ctx.getPart(LirothClient.MODEL_TALLPIER_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/tallpier.png");
    }

    public void render(PierBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        float k;
        matrixStack.push();
        ...
        PierBoatEntityModel model = this.model;
        Identifier identifier = texture;
        PierBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(PierBoatEntity entity) {
        return this.texture;
    }
