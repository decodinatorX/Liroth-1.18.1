...
public class ChestSpicedBoatEntityModel extends CompositeEntityModel<ChestSpicedBoatEntity> {
    ...
    public ChestSpicedBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(ChestSpicedBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(ChestSpicedBoatEntity entity, int sigma, ModelPart part, float angle) {
