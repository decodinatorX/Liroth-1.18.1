...
public class ChestPierBoatEntity
extends PierBoatEntity
...
VehicleInventory {
    ...
    public ChestPierBoatEntity(EntityType<? extends PierBoatEntity> entityType, World world) {
        super(entityType, world);
    }

    public ChestPierBoatEntity(World world, double d, double e, double f) {
        this(LirothEntities.CHEST_PIER_BOAT, world);
    ...
    @Override
    public Item asItem() {
    	return LirothItems.CHEST_PIER_BOAT;
    }
