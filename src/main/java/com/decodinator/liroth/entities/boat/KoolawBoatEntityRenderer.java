...
public class KoolawBoatEntityRenderer extends EntityRenderer<KoolawBoatEntity> {
    ...
    private final KoolawBoatEntityModel model;
    private final Identifier texture;


    public KoolawBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new KoolawBoatEntityModel(ctx.getPart(LirothFluidRenderingModClient.MODEL_KOOLAW_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/koolaw.png");
    }
    ...
    @Override
    public Identifier getTexture(KoolawBoatEntity entity) {
        return this.texture;
    }
