...
public class TallpierBoatEntityRenderer extends EntityRenderer<TallpierBoatEntity> {

    private final TallpierBoatEntityModel model;
    private final Identifier texture;


    public TallpierBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new TallpierBoatEntityModel(ctx.getPart(LirothFluidRenderingModClient.MODEL_TALLPIER_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/tallpier.png");
    }

    public void render(TallpierBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        TallpierBoatEntityModel model = this.model;
        Identifier identifier = texture;
        TallpierBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(TallpierBoatEntity entity) {
        return this.texture;
    }
