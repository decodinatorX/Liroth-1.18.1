...
public class SpicedBoatEntityModel extends CompositeEntityModel<SpicedBoatEntity> {
    ...
    public SpicedBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(SpicedBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(SpicedBoatEntity entity, int sigma, ModelPart part, float angle) {
