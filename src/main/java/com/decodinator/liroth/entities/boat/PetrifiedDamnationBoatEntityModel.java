...
public class PetrifiedDamnationBoatEntityModel extends CompositeEntityModel<PetrifiedDamnationBoatEntity> {
    ...
    public PetrifiedDamnationBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(PetrifiedDamnationBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(PetrifiedDamnationBoatEntity entity, int sigma, ModelPart part, float angle) {
