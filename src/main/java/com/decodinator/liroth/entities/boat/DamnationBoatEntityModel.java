...
public class DamnationBoatEntityModel extends CompositeEntityModel<DamnationBoatEntity> {
    ...
    public DamnationBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(DamnationBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(DamnationBoatEntity entity, int sigma, ModelPart part, float angle) {
