...
public class SpicedBoatEntityRenderer extends EntityRenderer<SpicedBoatEntity> {

    private final SpicedBoatEntityModel model;
    private final Identifier texture;


    public SpicedBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new SpicedBoatEntityModel(ctx.getPart(LirothFluidRenderingModClient.MODEL_SPICED_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/spiced.png");
    }

    public void render(SpicedBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        SpicedBoatEntityModel model = this.model;
        Identifier identifier = texture;
        SpicedBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(SpicedBoatEntity entity) {
        return this.texture;
    }
