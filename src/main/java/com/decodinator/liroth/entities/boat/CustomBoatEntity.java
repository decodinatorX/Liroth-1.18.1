...
public class CustomBoatEntity extends Entity {
    ...
    private CustomBoatEntity.Location location;
    private CustomBoatEntity.Location lastLocation;
...
//        this.inanimate = true;
    ...
    public CustomBoatEntity(World world, double x, double y, double z) {
        this(LirothEntities.LIROTH_BOAT, world);
    ...
    public void tick() {
        ...
        if (this.location != CustomBoatEntity.Location.UNDER_WATER && this.location != CustomBoatEntity.Location.UNDER_FLOWING_WATER) {
    ...
    private CustomBoatEntity.Location checkLocation() {
        CustomBoatEntity.Location location = this.getUnderWaterLocation();
        if (location != null) {
            this.waterLevel = this.getBoundingBox().maxY;
            return location;
        } else if (this.checkBoatInWater()) {
            return CustomBoatEntity.Location.IN_WATER;
        } else {
            float f = this.method_7548();
            if (f > 0.0F) {
                this.field_7714 = f;
                return CustomBoatEntity.Location.ON_LAND;
            } else {
                return CustomBoatEntity.Location.IN_AIR;
            }
        }
    }
    ...
    @Nullable
    private CustomBoatEntity.Location getUnderWaterLocation() {
        Box box = this.getBoundingBox();
                ...
                for(int q = m; q < n; ++q) {
                    ...
                    if (fluidState.isIn(FluidTags.WATER) && d < (double)((float)mutable.getY() + fluidState.getHeight(this.world, mutable))) {
                        if (!fluidState.isStill()) {
                            return CustomBoatEntity.Location.UNDER_FLOWING_WATER;
                        }
        ...
        return bl ? CustomBoatEntity.Location.UNDER_WATER : null;
    }
    ...
    private void updateVelocity() {
        ...
        if (this.lastLocation == CustomBoatEntity.Location.IN_AIR && this.location != CustomBoatEntity.Location.IN_AIR && this.location != CustomBoatEntity.Location.ON_LAND) {
            ...
            this.location = CustomBoatEntity.Location.IN_WATER;
        } else {
            if (this.location == CustomBoatEntity.Location.IN_WATER) {
                f = (this.waterLevel - this.getY()) / (double)this.getHeight();
                this.velocityDecay = 0.9F;
            } else if (this.location == CustomBoatEntity.Location.UNDER_FLOWING_WATER) {
                e = -7.0E-4D;
                this.velocityDecay = 0.9F;
            } else if (this.location == CustomBoatEntity.Location.UNDER_WATER) {
                f = 0.009999999776482582D;
                this.velocityDecay = 0.45F;
            } else if (this.location == CustomBoatEntity.Location.IN_AIR) {
                this.velocityDecay = 0.9F;
            } else if (this.location == CustomBoatEntity.Location.ON_LAND) {
        ...
        if (!this.hasVehicle()) {
            if (onGround) {
                if (this.fallDistance > 3.0F) {
                    if (this.location != CustomBoatEntity.Location.ON_LAND) {
    ...
    public boolean isSubmergedInWater() {
        return this.location == CustomBoatEntity.Location.UNDER_WATER || this.location == CustomBoatEntity.Location.UNDER_FLOWING_WATER;
    }
