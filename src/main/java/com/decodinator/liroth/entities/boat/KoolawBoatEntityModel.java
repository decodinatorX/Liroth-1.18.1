...
public class KoolawBoatEntityModel extends CompositeEntityModel<KoolawBoatEntity> {
    ...
    public KoolawBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(KoolawBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(KoolawBoatEntity entity, int sigma, ModelPart part, float angle) {
