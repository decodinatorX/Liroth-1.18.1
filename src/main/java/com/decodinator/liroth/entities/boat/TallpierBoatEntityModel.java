...
public class TallpierBoatEntityModel extends CompositeEntityModel<TallpierBoatEntity> {
    ...
    public TallpierBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(TallpierBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(TallpierBoatEntity entity, int sigma, ModelPart part, float angle) {
