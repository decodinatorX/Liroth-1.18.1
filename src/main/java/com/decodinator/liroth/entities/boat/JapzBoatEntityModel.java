...
public class JapzBoatEntityModel extends CompositeEntityModel<JapzBoatEntity> {
    ...
    public JapzBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(JapzBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(JapzBoatEntity entity, int sigma, ModelPart part, float angle) {
