...
public class JapzBoatEntityRenderer extends EntityRenderer<JapzBoatEntity> {

    private final JapzBoatEntityModel model;
    private final Identifier texture;


    public JapzBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new JapzBoatEntityModel(ctx.getPart(LirothFluidRenderingModClient.MODEL_JAPZ_BOAT_LAYER));
        this.texture = new Identifier(Liroth.MOD_ID, "textures/entity/boat/japz.png");
    }

    public void render(JapzBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        JapzBoatEntityModel model = this.model;
        Identifier identifier = texture;
        JapzBoatEntityModel boatEntityModel = model;
    ...
    @Override
    public Identifier getTexture(JapzBoatEntity entity) {
        return this.texture;
    }
