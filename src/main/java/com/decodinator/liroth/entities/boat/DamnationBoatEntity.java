...
public class DamnationBoatEntity extends Entity {
    ...
    private DamnationBoatEntity.Location location;
    private DamnationBoatEntity.Location lastLocation;
    ...
    public DamnationBoatEntity(EntityType<? extends DamnationBoatEntity> type, World world) {
        super(type, world);
...
//        this.inanimate = true;
    ...
    private DamnationBoatEntity.Location checkLocation() {
        DamnationBoatEntity.Location location = this.getUnderWaterLocation();
        if (location != null) {
            this.waterLevel = this.getBoundingBox().maxY;
            return location;
        } else if (this.checkBoatInWater()) {
            return DamnationBoatEntity.Location.IN_WATER;
        } else {
            float f = this.method_7548();
            if (f > 0.0F) {
                this.field_7714 = f;
                return DamnationBoatEntity.Location.ON_LAND;
            } else {
                return DamnationBoatEntity.Location.IN_AIR;
            }
        }
    }
    ...
    @Nullable
    private DamnationBoatEntity.Location getUnderWaterLocation() {
        Box box = this.getBoundingBox();
                ...
                for(int q = m; q < n; ++q) {
                    ...
                    if (fluidState.isIn(FluidTags.WATER) && d < (double)((float)mutable.getY() + fluidState.getHeight(this.world, mutable))) {
                        if (!fluidState.isStill()) {
                            return DamnationBoatEntity.Location.UNDER_FLOWING_WATER;
                        }
        ...
        return bl ? DamnationBoatEntity.Location.UNDER_WATER : null;
    }
    ...
    private void updateVelocity() {
        ...
        if (this.lastLocation == DamnationBoatEntity.Location.IN_AIR && this.location != DamnationBoatEntity.Location.IN_AIR && this.location != DamnationBoatEntity.Location.ON_LAND) {
            ...
            if (this.location == DamnationBoatEntity.Location.IN_WATER) {
                f = (this.waterLevel - this.getY()) / (double)this.getHeight();
                this.velocityDecay = 0.9F;
            } else if (this.location == DamnationBoatEntity.Location.UNDER_FLOWING_WATER) {
                e = -7.0E-4D;
                this.velocityDecay = 0.9F;
            } else if (this.location == DamnationBoatEntity.Location.UNDER_WATER) {
                f = 0.009999999776482582D;
                this.velocityDecay = 0.45F;
            } else if (this.location == DamnationBoatEntity.Location.IN_AIR) {
                this.velocityDecay = 0.9F;
            } else if (this.location == DamnationBoatEntity.Location.ON_LAND) {
        ...
        if (!this.hasVehicle()) {
            if (onGround) {
                if (this.fallDistance > 3.0F) {
                    if (this.location != DamnationBoatEntity.Location.ON_LAND) {
    ...
    public boolean isSubmergedInWater() {
        return this.location == DamnationBoatEntity.Location.UNDER_WATER || this.location == DamnationBoatEntity.Location.UNDER_FLOWING_WATER;
    }
