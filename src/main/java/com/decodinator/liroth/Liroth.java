...
public class Liroth implements ModInitializer {
    ...
    public static BlockEntityType<FungalCampfireBlockEntity> FUNGAL_CAMPFIRE_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "fungal_campfire"), FabricBlockEntityTypeBuilder.create(FungalCampfireBlockEntity::new, LirothBlocks.FUNGAL_CAMPFIRE).build(null));
    public static BlockEntityType<LirothianPetroleumCampfireBlockEntity> LIROTHIAN_PETROLEUM_CAMPFIRE_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "lirothian_petroleum_campfire"), FabricBlockEntityTypeBuilder.create(LirothianPetroleumCampfireBlockEntity::new, LirothBlocks.LIROTHIAN_PETROLEUM_CAMPFIRE).build(null));
    public static BlockEntityType<QuantumBlockEntity> QUANTUM_EXTRACTOR_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "quantum_extractor"), FabricBlockEntityTypeBuilder.create(QuantumBlockEntity::new, LirothBlocks.QUANTUM_EXTRACTOR).build(null));
    public static BlockEntityType<SplitterBlockEntity> LIROTH_SPLITTER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "liroth_splitter"), FabricBlockEntityTypeBuilder.create(SplitterBlockEntity::new, LirothBlocks.LIROTH_SPLITTER).build(null));
...
//    public static ScreenHandlerType<QuantumExtractorScreenHandler> QUANTUM_EXTRACTOR_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new ResourceLocation(Liroth.MOD_ID, "quantum_extractor"), QuantumExtractorScreenHandler::new);
    ...
    public static final CreativeModeTab creativeItemsTab = FabricItemGroupBuilder.build(new ResourceLocation(Liroth.MOD_ID, "liroth_items"), () -> new ItemStack(LirothItems.LIROTH_GEM));
    public static final CreativeModeTab creativeBlocksTab = FabricItemGroupBuilder.build(new ResourceLocation(Liroth.MOD_ID, "liroth_blocks"), () -> new ItemStack(LirothBlocks.LIROTH_GEM_BLOCK));
    public static final CreativeModeTab creativeCombatTab = FabricItemGroupBuilder.build(new ResourceLocation(Liroth.MOD_ID, "liroth_combat"), () -> new ItemStack(LirothItems.LIROTH_SWORD));
    public static final CreativeModeTab creativeEntitiesTab = FabricItemGroupBuilder.build(new ResourceLocation(Liroth.MOD_ID, "liroth_entities"), () -> new ItemStack(LirothItems.UNOBTAINABLE_FORSAKEN_CORPSE_SPAWN_EGG));
    public static final CreativeModeTab creativePlantsTab = FabricItemGroupBuilder.build(new ResourceLocation(Liroth.MOD_ID, "liroth_plants"), () -> new ItemStack(LirothBlocks.LIROTH_ROSE));
	    ...
	    public static class LirothRegistries {
	        ...
	        public static void registerFeatures() {
				...
				LirothFeatures.init();   
				LirothConfiguredFeatures.init();
				LirothPlacedFeatures.init();
