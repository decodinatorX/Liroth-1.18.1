...
public class LirothChestBoat extends LirothBoat implements HasCustomInventoryScreen, ContainerEntity {
   ...
   public LirothChestBoat(EntityType<? extends LirothBoat> p_219869_, Level p_219870_) {
      super(p_219869_, p_219870_);
   }

   public LirothChestBoat(Level p_219872_, double p_219873_, double p_219874_, double p_219875_) {
      this(LirothEntities.CHEST_LIROTH_BOAT, p_219872_);
   ...
   public Item getDropItem() {
      ...
      switch (this.getLirothBoatType()) {
         case DAMNATION:
            item = LirothItems.CHEST_DAMNATION_BOAT;
            break;
         case SPICED:
            item = LirothItems.CHEST_SPICED_BOAT;
            break;
         case PIER:
            item = LirothItems.CHEST_PIER_BOAT;
            break;
         case JAPZ:
            item = LirothItems.CHEST_JAPZ_BOAT;
            break;
         case KOOLAW:
            item = LirothItems.CHEST_KOOLAW_BOAT;
            break;
         case PETRIFIED:
            item = LirothItems.CHEST_PETRIFIED_BOAT;
            break;
         default:
            item = LirothItems.CHEST_LIROTH_BOAT;
      }
