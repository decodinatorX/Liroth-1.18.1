...
public class PotestiumHelmetModel extends BipedEntityModel<LivingEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r6 = Helm.addChild("cube_r6", ModelPartBuilder.create().uv(38, 19).cuboid(-1.0F, -28.5F, -5.0F, 2.0F, 2.0F, 4.0F), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.3054F, 0.0F, 0.0F));

		ModelPartData cube_r7 = Helm.addChild("cube_r7", ModelPartBuilder.create().uv(22, 19).cuboid(-1.5F, -28.5F, -5.0F, 3.0F, 3.0F, 5.0F), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));
