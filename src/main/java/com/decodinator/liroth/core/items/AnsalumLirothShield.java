...
extends Item {
    ...
    public boolean isValidRepairItem(ItemStack stack, ItemStack ingredient) {
        return ingredient.is(LirothItems.LIROTH_GEM_ANSALUM) || super.isValidRepairItem(stack, ingredient);
    }
}