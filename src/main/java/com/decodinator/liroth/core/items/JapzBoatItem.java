...
extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        BlockHitResult hitResult = JapzBoatItem.raycast(world, user, RaycastContext.FluidHandling.ANY);
        ...
        if (((HitResult)hitResult).getType() == HitResult.Type.BLOCK) {
        	JapzBoatEntity JapzBoatEntity = this.createEntity(world, hitResult);
        	JapzBoatEntity.setYaw(user.getYaw());
            if (!world.isSpaceEmpty(JapzBoatEntity, JapzBoatEntity.getBoundingBox())) {
