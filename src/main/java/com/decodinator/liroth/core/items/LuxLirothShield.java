...
extends Item {
    ...
    public boolean isValidRepairItem(ItemStack stack, ItemStack ingredient) {
        return ingredient.is(LirothItems.LIROTH_GEM_LUX) || super.isValidRepairItem(stack, ingredient);
    }
}