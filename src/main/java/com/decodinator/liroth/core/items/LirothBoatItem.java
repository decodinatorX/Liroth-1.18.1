...
import com.decodinator.liroth.core.LirothChestBoat;
...
public class LirothBoatItem extends Item {
   ...
   private LirothBoat getBoat(Level p_220017_, HitResult p_220018_) {
      return (LirothBoat)(this.hasChest ? new LirothChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new LirothBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
   }
}