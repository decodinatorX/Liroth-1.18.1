...
public class SalemArmorItem extends ArmorItem {
    ...
    private void addStatusEffectForMaterial(Player player, ArmorMaterial mapArmorMaterial, MobEffectInstance mapStatusEffect) {
        ...
        if(hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 400, 1, true, false, false));
            player.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 400, 1, true, false, false));
