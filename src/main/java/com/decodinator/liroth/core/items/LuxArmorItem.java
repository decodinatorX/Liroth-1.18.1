...
public class LuxArmorItem extends ArmorItem {
    ...
    private void addStatusEffectForMaterial(PlayerEntity player, ArmorMaterial mapArmorMaterial, StatusEffectInstance mapStatusEffect) {
        ...
        if(hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            ...
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.HASTE, 200, 1, true, false, false));
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 200, 1, true, false, false));
