...
public class LuxArmorItem extends ArmorItem {
    ...
    private void addStatusEffectForMaterial(Player player, ArmorMaterial mapArmorMaterial, MobEffectInstance mapStatusEffect) {
        ...
        if(hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 200, 1, true, false, false));
            player.addEffect(new MobEffectInstance(MobEffects.SATURATION, 200, 1, true, false, false));
