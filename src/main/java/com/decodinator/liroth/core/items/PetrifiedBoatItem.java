...
extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        BlockHitResult hitResult = PetrifiedBoatItem.raycast(world, user, RaycastContext.FluidHandling.ANY);
        ...
        if (((HitResult)hitResult).getType() == HitResult.Type.BLOCK) {
        	PetrifiedBoatEntity PetrifiedBoatEntity = this.createEntity(world, hitResult);
        	PetrifiedBoatEntity.setYaw(user.getYaw());
            if (!world.isSpaceEmpty(PetrifiedBoatEntity, PetrifiedBoatEntity.getBoundingBox())) {
