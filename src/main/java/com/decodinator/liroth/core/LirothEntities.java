...
public class LirothEntities {
    ...
    public static void RegisterEntities() {
        ...
        DAMNATION_BOAT = Registry.register(Registry.ENTITY_TYPE, new Identifier(Liroth.MOD_ID, "damnation_boat"), FabricEntityTypeBuilder.<DamnationBoatEntity>create(SpawnGroup.CREATURE, DamnationBoatEntity::new).size(EntityDimensions.fixed(1.375F, 0.5625F)).build());
    }
}
