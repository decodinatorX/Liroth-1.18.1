...
public class LirothEntities {
    ...
    public static void init() {
        Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "liroth_boat"), LIROTH_BOAT);
        Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(Liroth.MOD_ID, "chest_liroth_boat"), CHEST_LIROTH_BOAT);
    }
}
