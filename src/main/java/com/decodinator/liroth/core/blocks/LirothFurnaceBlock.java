...
*/
public class LirothFurnaceBlock
extends AbstractFurnaceBlock {
   public LirothFurnaceBlock(AbstractBlock.Settings settings) {
       super(settings);
   }
   ...
   public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
       return LirothFurnaceBlock.checkType(world, type, BlockEntityType.FURNACE);
   }
