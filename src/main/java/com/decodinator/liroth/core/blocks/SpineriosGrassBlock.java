...
public class SpineriosGrassBlock extends SpineriosSpreadableBlock implements BonemealableBlock {
	   public SpineriosGrassBlock(BlockBehaviour.Properties p_53685_) {
		      super(p_53685_);
		   }
