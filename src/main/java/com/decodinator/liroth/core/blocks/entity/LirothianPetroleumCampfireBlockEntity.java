...
implements Clearable {
    ...
    public static void litServerTick(World world, BlockPos pos, BlockState state, LirothianPetroleumCampfireBlockEntity campfire) {
        boolean bl = false;
    ...
    public static void unlitServerTick(World world, BlockPos pos, BlockState state, LirothianPetroleumCampfireBlockEntity campfire) {
        boolean bl = false;
        for (int i = 0; i < campfire.itemsBeingCooked.size(); ++i) {
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, LirothianPetroleumCampfireBlockEntity campfire) {
        int i;
